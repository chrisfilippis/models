...
tf.app.flags.DEFINE_string('training_folder',
...
tf.app.flags.DEFINE_string(
    'list_folder',
    'data/annotator/segmentation',
    'Folder containing lists for training and validation')

tf.app.flags.DEFINE_string(
    'output_dir',
    'data/output/tfrecord',
...
def main(unused_argv):
  ...
  if os.path.isfile(os.path.join( os.path.abspath(FLAGS.output_folder), 'index.txt')):
    return

  preprocess_coco.process_data(FLAGS.training_folder, FLAGS.output_folder)
